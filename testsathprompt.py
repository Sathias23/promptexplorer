...
print(x.combineFragments(sathprompt.CombineMethod.SELECT_NUM_DIRECTIONAL, sathprompt.Direction.POSITIVE))
print(x.combineFragments(sathprompt.CombineMethod.SELECT_NUM_DIRECTIONAL, sathprompt.Direction.NEGATIVE))
